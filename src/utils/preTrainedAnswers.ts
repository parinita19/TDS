...
const initialPreTrainedData: QuestionAnswer[] = [
  {
    question: "Running uv run --with httpie -- https [URL] installs the Python package httpie and sends a HTTPS request to the URL. Send a HTTPS request to https://httpbin.org/get with the URL encoded parameter email set to 23f2003537@ds.study.iitm.ac.in What is the JSON output of the command?",
    answer: '{\n  "args": {\n    "email": "23f2003537@ds.study.iitm.ac.in"\n  },\n  "headers": {\n    "Accept": "*/*",\n    "Accept-Encoding": "gzip, deflate",\n    "Host": "httpbin.org",\n    "User-Agent": "HTTPie/3.2.2",\n    "X-Amzn-Trace-Id": "Root=1-65f3a8b6-61e2b7c73f7b9fbe6e62ff6b"\n  },\n  "origin": "49.207.203.53",\n  "url": "https://httpbin.org/get?email=23f2003537%40ds.study.iitm.ac.in"\n}',
    topic: "GA1"
  },
  {
